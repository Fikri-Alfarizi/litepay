...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2">Join us to track your purchases easier</p>
        </div>

        <form action="{{ route('customer.register.submit') }}" method="POST" class="bg-white p-8 rounded-2xl shadow-xl">
            @csrf
        ...
        <p class="text-center mt-6 text-gray-600">
            ...
            <a href="{{ route('customer.login') }}" class="text-blue-600 font-bold hover:underline">Login</a>
        </p>
    </div>
</body>
