...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden group hover:shadow-md transition">
            <div class="h-24 bg-gradient-to-r from-purple-500 to-indigo-600 p-4 flex items-center justify-center text-white relative overflow-hidden">
                ...
                <div class="text-center relative z-10">
                    <h3 class="text-xl font-bold">LITEPAY50</h3>
                    <p class="text-xs opacity-90">50% Off Transaction Fees</p>
                </div>
            </div>
            <div class="p-4">
                <div class="flex justify-between items-center mb-2">
                    <span class="bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 text-[10px] px-1.5 py-0.5 rounded font-bold">Active</span>
                     <span class="text-xs text-gray-500 dark:text-gray-400">Used: 1,234 times</span>
                </div>
        ...
        <!-- Active Promo 2 -->
         <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden group hover:shadow-md transition">
            <div class="h-24 bg-gradient-to-r from-orange-500 to-red-600 p-4 flex items-center justify-center text-white relative overflow-hidden">
                 <svg class="w-20 h-20 absolute -left-4 -top-4 opacity-20 transform -rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12a2 2 0 110 4h14a2 2 0 110-4"></path></svg>
                <div class="text-center relative z-10">
                    <h3 class="text-xl font-bold">NEWUSER</h3>
                    <p class="text-xs opacity-90">Free First Month</p>
                </div>
            </div>
            <div class="p-4">
                <div class="flex justify-between items-center mb-2">
                    <span class="bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 text-[10px] px-1.5 py-0.5 rounded font-bold">Active</span>
                     <span class="text-xs text-gray-500 dark:text-gray-400">Used: 89 times</span>
                </div>
                 <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mb-3">
                    <div class="bg-orange-500 h-1.5 rounded-full" style="width: 15%"></div>
                </div>
                 <div class="flex justify-between text-[10px] text-gray-500 dark:text-gray-400 mb-4">
