...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-500 mt-1">Manage allowed IP addresses for API access.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap font-mono text-sm text-gray-700">{{ $ip[0] }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ip[1] }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ip[2] }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ip[3] }}</td>
